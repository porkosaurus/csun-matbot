...
const Home = () => {
      ...
      const testChats = [
        {
          ...
          context: '',
          appendedResponses: `
            <div class="chat-container" data-base-answer=>
              <p class="chat-bubble chat-bubble-question mb-4 text-sm md:text-lg">What subjects are offered at the SMART Lab?</p>
  ...
  <img src={csunlogo} alt="CSUN Logo" className='h-auto max-h-20 md:max-h-32 lg:max-h-40 w-auto object-contain' />
    ...
    <h1 className='text-lg md:text-4xl font-semibold ml-4 md:ml-16'>MatBot</h1>
        ...
        <div className='pt-2 h-[95vh]'>
          <div className='h-[70%] overflow-y-auto mt-12 pr-4 pl-4' onClick={(event) => {
